...
From [npm](https://www.npmjs.com/package/justino-ig-fetcher)

`yarn add justino-ig-fetcher`

or

`npm i justino-ig-fetcher --save`

### Test

- `git clone https://github.com/rafaeljustinox/justino-ig-fetcher.git`
...
```js
const Insta = require('justino-ig-fetcher');
